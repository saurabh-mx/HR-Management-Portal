...
export const Sidebar = () => {
  ...
  return (
    <div className="w-64 h-full bg-slate-950/90 backdrop-blur-md border-r border-yellow-900/30 flex flex-col shadow-[5px_0_15px_rgba(0,0,0,0.5)] z-20 relative">
      {/* Sidebar Header */}
      <div className="h-16 flex items-center px-6 border-b border-yellow-900/30 bg-slate-950">
        <h2 className="text-lg font-extrabold tracking-widest text-slate-200 uppercase flex items-center gap-2 drop-shadow-md">
          SASP <span className="text-yellow-500 font-light">COMMAND</span>
        </h2>
      </div>
          ...
          return (
            <Link
              ...
              className={cn(
                ...
                isActive 
                  ? "bg-yellow-500/10 text-yellow-500 border-yellow-500/30 shadow-[0_0_10px_rgba(234,179,8,0.1)] translate-x-1" 
                  : "text-slate-400 hover:text-yellow-400 hover:bg-slate-900 hover:border-yellow-900/50 hover:translate-x-1"
              )}
            >
              <Icon className={cn(
                "w-5 h-5 transition-colors duration-200", 
                isActive ? "text-yellow-500" : "text-slate-500 group-hover:text-yellow-400"
              )} />
              {item.name}
            </Link>
          );
      ...
      <div className="p-4 border-t border-yellow-900/30 bg-slate-900/50">
        <div className="flex items-center gap-3 px-2">
          <div className="w-10 h-10 rounded-sm bg-slate-950 flex items-center justify-center text-yellow-500 font-bold text-xs border border-yellow-600/30 shadow-md rotate-45">
          ...
          <div className="flex flex-col overflow-hidden ml-2">
            ...
            <span className="text-xs text-yellow-500/80 tracking-widest uppercase truncate">
