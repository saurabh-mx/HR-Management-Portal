  ...
  return (
    <div className="space-y-6 p-6">
      <div>
        ...
        <p className="text-sm text-slate-400 mt-1">Department schedule for mandatory roll calls, trainings, and briefings.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {meetings.length === 0 ? (
          ...
          meetings.map((meeting) => (
            <Card key={meeting.id} className="bg-slate-900 border-slate-800 text-slate-200 flex flex-col">
