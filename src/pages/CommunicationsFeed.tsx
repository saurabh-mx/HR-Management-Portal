...
import { Radio, Send, Megaphone, AlertCircle, ShieldAlert, Trash2 } from "lucide-react";
...
export default function CommunicationsFeed() {
  ...
  async function fetchCurrentUser() {
    ...
    // Grab their real officer name from the employees table if available
    ...
    <div className="space-y-6 p-6">
      <div>
        <h1 className="text-3xl font-bold tracking-tight text-white flex items-center gap-3">
          <Radio className="w-8 h-8 text-sky-500 animate-pulse" />
