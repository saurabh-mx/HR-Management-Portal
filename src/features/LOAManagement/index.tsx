  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (data) {
      ...
      sendDiscordNotification({
        ...
        color: 0x3498db, // Blue
        fields: [
          { name: "Officer", value: authorName, inline: true },
          { name: "Status", value: "Pending Review", inline: true },
          { name: "Start Date", value: newRequest.start_date, inline: true },
          { name: "End Date", value: newRequest.end_date, inline: true },
          { name: "Reason", value: newRequest.reason, inline: false }
        ],
